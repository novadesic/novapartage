...
# Script pour construire et dockeriser le email-service (Node.js)
set -euo pipefail

echo "Début du build et dockerisation de email-service..."
...
IMAGE_NAME="ghcr.io/novadesic/novapartage-email-service:latest"
...
echo "✅ Build et dockerisation de email-service terminés avec succès!"
